...
function finalizarFlujoCiclo6x2Inicial(){
  ciclo6x2AplicadoInicial = true;
  if (typeof establecerFlujoCiclo6x2 === "function") {
    establecerFlujoCiclo6x2(false);
  } else {
    const auto = document.getElementById("autoCiclo6x2Interno");
    if (auto) auto.value = "no";
  }
}
...
function manejarCambioCalendario(e){
  ...
  if (e.target.classList.contains("turno-dia")) {
    ...
    const autoCiclo = (document.getElementById("autoCiclo6x2Interno")?.value || "no") === "si";
